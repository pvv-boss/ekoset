...
export default class BaseService {
  ...
  protected buildHttRequest(query: string, format?: DisplayFormatType, sort?: Sort, pagination?: Pagination): string {
    return this.internalBuildHttRequest('biddings', query, format, sort, pagination)
  }
  ...
  protected internalBuildHttRequest(mainSection: string, query: string, format?: DisplayFormatType, sort?: Sort, pagination?: Pagination): string {
    let request = `${AppConfig.endPoint}/${mainSection}/${query}`
