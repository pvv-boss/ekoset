<template>
  <div class="brc-feedback">
    <h2 style="text-align: center !important">Персональный менеджер</h2>
    <form class="brc-message-form my-manager-wrapper">
      <div class="my-manager-contacts">
        ...
        <div class="my-manager-contacts__main">
          ...
          >
          <span class="my-manager-contacts__main__name">{{
            myManager.managerName
          }}</span>
          <span class="my-manager-contacts__main__phone">{{
            managerPhoneNumber()
          }}</span>
          <span class="my-manager-contacts__main__mail"
            ><a :href="`mailto:${myManager.managerEmail}`">{{
              myManager.managerEmail
            }}</a></span
          >
        </div>
      </div>
      <div class="my-manager-form">
        ...
        <div class="brc-message-form__button my-manager-form__attach_wrapper">
          ...
          <button
            disable
            class="button my-manager-form__button"
            @click="sendMessage"
          >
            Отправить сообщение
          </button>
...
export default class MyManager extends Vue {
  ...
  private get myManager (): EkosetClient {
