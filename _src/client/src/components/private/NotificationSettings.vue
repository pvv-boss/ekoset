<template>
  <div class="profile-notif red-inputs">
    <h3>Получать уведомления</h3>
    <div class="profile-notif__deesc">
      Для Вашего удобства мы напомним Вам о предстоящих работах или
      заканчивающихся документах
    </div>
