      ...
      >
        <div class="brc-login-form__block">
          ...
          <input
            ...
            class="login-input"
          />
          <span v-if="invalidPassword" class="error-message">{{ invalidPassword }}</span>
        </div>
        <div class="brc-login-form__block">
          ...
          <input
            ...
            class="login-input"
          />
          <span v-if="validateMessage" class="error-message">{{ validateMessage }}</span>
        </div>
        <button :disabled="submitPending" class="brc-change-pwd-form__submit_form" type="submit">Сменить</button>
      </form>
    </div>
  </div>
</template>
