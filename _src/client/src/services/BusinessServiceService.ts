...
export default class BusinessServiceService extends BaseService {
    ...
    public async getByActivityAndBySiteSectionSlug(
        siteSectionSlug: string,
    ...
    public async save(businessService: BusinessService) {
        ...
        if (businessService.smallImageFormData) {
            this.context.$serviceRegistry
                ...
                .saveServiceImage(businessService.businessServiceId, businessService.smallImageFormData, false);
        }
        if (businessService.bigImageFormData) {
            this.context.$serviceRegistry
                .getService(MediaService)
                .saveServiceImage(businessService.businessServiceId, businessService.bigImageFormData, true);
        }
    ...
    public async adminGetFooterServicesRelation(isBusinessType: boolean) {
        return (await this.apiRequest.getJSON(`admin/panel/footer/relation/${isBusinessType ? "business" : "private"}`)).data
            ?.data;
    }
    // ---
    ...
    private async getByActivityAndBySiteSectionId(
