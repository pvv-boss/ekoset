...
import { BaseController, NotFound, ServiceRegistry } from "rsn-express-core";
...
export default class BusinessServiceController extends BaseController {
    ...
    public async getMainList(@Res() response: Response) {
    ...
    public async getAllBySiteSectionId(
        ...
        const result = await ServiceRegistry.instance
            ...
            .getAllBySiteSectionId(siteSectionId, excludeChild);
        return this.createSuccessResponse(result, response);
    }

    @Get("/admin/panel/:sitesection/services")
    public async adminGetAllBySiteSectionId(@Res() response: Response, @Param("sitesection") siteSectionId: number) {
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .adminGetAllBySiteSectionId(siteSectionId);
        return this.createSuccessResponse(result, response);
    }
    ...
    public async getByActivityAndBySiteSectionId(
        ...
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .getByActivityAndBySiteSectionId(siteSectionId, activityTypeId, excludeChild);
        return this.createSuccessResponse(result, response);
    }
    ...
    public async getForPrivatePersonBySiteSectionId(
        ...
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .getForPrivatePersonBySiteSectionId(siteSectionId, excludeChild);
        return this.createSuccessResponse(result, response);
    }
    ...
    public async getForBusinessBySiteSectionId(
        ...
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .getForBusinessBySiteSectionId(siteSectionId, excludeChild);
        return this.createSuccessResponse(result, response);
    }

    @Get("/services/footer/private")
    public async getFooterServicesForPrivateClient(@Res() response: Response) {
    ...
    public async getFooterServicesForBusinessClient(@Res() response: Response) {
    ...
    public async getChildServicesByParentId(@Res() response: Response, @Param("service") parentServiceId: number) {
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .getChildServicesByParentId(parentServiceId);
        return this.createSuccessResponse(result, response);
    }

    @Get("/admin/panel/services/:service/children")
    public async adminGetChildServicesByParentId(@Res() response: Response, @Param("service") parentServiceId: number) {
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .adminGetChildServicesByParentId(parentServiceId);
        return this.createSuccessResponse(result, response);
    }

    @Get("/services/:service")
    public async getById(@Res() response: Response, @Param("service") serviceId: number) {
        const result = await ServiceRegistry.instance.getService(BusinessServiceService).getById(serviceId);
        if (!result) {
            return this.createFailureResponse(new NotFound("Не удалось найти услугу"), response);
        }
        return this.createSuccessResponse(result, response);
    }

    @Put("/services")
    public async save(@Body() businessService: BusinessService, @Res() response: Response) {
    ...
    public async getAdminСlActivitiesForService(@Res() response: Response, @Param("serviceId") serviceId: number) {
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .getAdminСlActivitiesForService(serviceId);
        return this.createSuccessResponse(result, response);
    }

    @Get("/admin/panel/service/:serviceId/clclient")
    public async getAdminclClientsForService(@Res() response: Response, @Param("serviceId") serviceId: number) {
    ...
    public async setPrivatePerson2Service(@Param("id") id: number, @Res() response: Response) {
    ...
    public async setBusinessType2Service(@Param("id") id: number, @Res() response: Response) {
    ...
    public async setActivityType2Service(@Param("id") id: number, @Param("typeid") typeid: number, @Res() response: Response) {
    ...
    public async removePrivatePersonFromService(@Param("id") id: number, @Res() response: Response) {
    ...
    public async removeBusinessTypeFromService(@Param("id") id: number, @Res() response: Response) {
    ...
    public async removeActivityTypeFromService(
        ...
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .removeActivityTypeFromService(id, typeid);
        return this.createSuccessResponse(result, response);
    }

    @Get("/admin/panel/services/:serviceId/relation")
    public async adminGetServiceRelation(@Res() response: Response, @Param("serviceId") serviceId: number) {
    ...
    public async adminGetRelated(@Res() response: Response, @Param("serviceId") serviceId: number) {
    ...
    public async adminAddRelated(
        ...
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .adminAddRemoveRelated(serviceId, relatedServiceId, priority, true);
        return this.createSuccessResponse(result, response);
    }
    ...
    public async adminRemoveRelated(
        ...
        const result = await ServiceRegistry.instance
            .getService(BusinessServiceService)
            .adminAddRemoveRelated(serviceId, relatedServiceId, priority, false);
        return this.createSuccessResponse(result, response);
    }
}
