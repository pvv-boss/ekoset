...
import { BaseController, ClientNotifyMessage, NotFound, ServiceRegistry } from "rsn-express-core";
...
export default class MainEkosetController extends BaseController {
    @Get("/activities")
    public async getSiteSections(@Res() response: Response) {
    ...
    public async adminGetSiteSections(@Res() response: Response) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).adminGetSiteSections();
        return this.createSuccessResponse(result, response);
    }

    @Get("/activities/:sitesection")
    public async getSiteSectionById(@Res() response: Response, @Param("sitesection") siteSectionId?: number) {
        if (Number.isNaN(siteSectionId)) {
            this.createFailureResponse(new NotFound(""), response);
        }
    ...
    public async getSiteSectionNameById(@Res() response: Response, @Param("sitesection") siteSectionId?: number) {
        if (!!siteSectionId) {
    ...
    public async getAdminForBusinessServiceBrands(@Res() response: Response, @Param("serviceId") serviceId: number) {
    ...
    public async adminGetAllBands(@Res() response: Response) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).getAdminAllBands();
        return this.createSuccessResponse(result, response);
    }

    @Get("/admin/panel/brands/:brandId")
    public async adminGetBrandById(@Param("brandId") brandId: number, @Res() response: Response) {
    ...
    public async adminGetClActivityList(@Res() response: Response) {
    ...
    public async adminSaveClActivity(@Body() clActivity: ClActivityType, @Res() response: Response) {
    ...
    public async deleteClActivity(@Param("id") clActivityID: number, @Res() response: Response) {
        try {
            ...
            return this.createSuccessResponseWithMessage(
                ...
                response,
                200,
                ClientNotifyMessage.createAlert(" Внимание ", "Данная запись используется и её удалить нельзя !")
            );
        }
    }

    @Get("/admin/panel/brands/activities/:sitesection")
    public async getAdminForSiteSectionBrands(@Res() response: Response, @Param("sitesection") siteSectionId: number) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).getAdminForSiteSectionBrands(siteSectionId);
        return this.createSuccessResponse(result, response);
    }

    @Get("/brands")
    public async getBrandsForHomePage(@Res() response: Response) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).getBrandsForHomePage();
        return this.createSuccessResponse(result, response);
    }

    @Get("/:sitesection/brands")
    public async getBrandsBySiteSection(@Res() response: Response, @Param("sitesection") siteSectionId: number) {
        if (Number.isNaN(siteSectionId)) {
    ...
    public async getByBusinessService(@Res() response: Response, @Param("service") serviceId: number) {
    ...
    public async removeBrandFromSiteSection(
        ...
        const result = await ServiceRegistry.instance
            .getService(MainEkosetService)
            .removeBrandFromSiteSection(brandId, siteSectionId);
        return this.createSuccessResponse(result, response);
    }
    ...
    @Put("/brands")
    public async saveBrand(@Body() clBrand: ClBrand, @Res() response: Response) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).saveBrand(clBrand);
        return this.createSuccessResponse(result, response);
    }

    @Delete("/brands/:id(\\d+)")
    public async deleteBrand(@Param("id") id: number, @Res() response: Response) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).deleteBrand(id);
        return this.createSuccessResponse(result, response);
    }

    @Put("/activities")
    public async saveSiteSection(@Body() siteSection: SiteSection, @Res() response: Response) {
    ...
    public async deleteSiteSection(@Param("id") id: number, @Res() response: Response) {
    ...
    public async getRecommendationLettersByBrand(@Res() response: Response, @Param("brandId") brandId: number) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).getRecommendationLettersByBrand(brandId);
        return this.createSuccessResponse(result, response);
    }

    @Get("/letters")
    public async getRecommendationLettersForHomePage(@Res() response: Response) {
    ...
    public async getRecommendationLettersBySiteSection(@Res() response: Response, @Param("sitesection") siteSectionId: number) {
        const result = await ServiceRegistry.instance
            .getService(MainEkosetService)
            .getRecommendationLettersBySiteSection(siteSectionId);
        return this.createSuccessResponse(result, response);
    }

    @Get("/letters/services/:service(\\d+)")
    public async getRecommendationLettersByBusinessService(@Res() response: Response, @Param("service") serviceId: number) {
        const result = await ServiceRegistry.instance
            .getService(MainEkosetService)
            .getRecommendationLettersByBusinessService(serviceId);
        return this.createSuccessResponse(result, response);
    }

    @Get("/clients")
    public async getClientsInfo(@Res() response: Response) {
        const result = await ServiceRegistry.instance.getService(MainEkosetService).getClientsInfo();
        return this.createSuccessResponse(result, response);
    }

    @Get("/clients/activity/:id")
    public async getClientsInfoByActivity(@Res() response: Response, @Param("id") activityId: number) {
    ...
    // Сохранить
    @Put("/brands/letters")
    public async saveRecommendation(@Body() reccomendationLetter: ReccomendationLetter, @Res() response: Response) {
    ...
    public async deleteRecommendationLetter(@Param("id") id: number, @Res() response: Response) {
