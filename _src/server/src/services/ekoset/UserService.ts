...
import { BaseService, ConfigManager, DatabaseConfig, Guid, postgresWrapper, RegistrationResult, RegistrationService, RegistrationStatus, ServiceRegistry, TypeOrmManager } from 'rsn-express-core';
    ...
    public async activateEkosetClient (clientId: number) {
        ...
        try {
            ...
            if (!!client) {
                ...
                result = await ServiceRegistry.instance.getService(RegistrationService).registerUser(client.personEmail, password, null);
